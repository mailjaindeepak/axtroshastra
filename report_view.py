...
/* summary grid */
.sgrid{display:grid;grid-template-columns:1fr 1fr;gap:11px;width:100%;margin-top:16px}
.scard{background:linear-gradient(162deg,#fff,#FBF5EA);border:1px solid var(--box-line);border-radius:13px;padding:14px 14px;text-align:left;box-shadow:0 3px 12px rgba(70,50,20,.04);display:flex;flex-direction:column;justify-content:center;min-height:132px}
...
.sfoot{width:100%;text-align:left;font-family:var(--sans);font-size:12.5px;color:var(--mauve);font-style:italic;margin-top:15px;line-height:1.5}
...
def render_vyapar(p: dict) -> str:
    ...
    return f"""<!DOCTYPE html><html lang="en"><head><meta charset="utf-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>{name} — Vyapar Business Report | Axtroshastra</title>
<style>
{_VYAPAR_CSS}
</style></head><body>
{_VYAPAR_DEFS}
...
<section class="page sand"><div class="col">
  <div class="cov-brand">AxtroShastra · Vyapar — Business Growth</div>
  ...
  <div class="cov-type"><svg class="ti" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M3 14l4-4 3 3 6-7"/><path d="M13 4h4v4"/></svg><span>{cov_sub}.</span></div>
  <div class="cov-pills"><span class="cp"><span class="g">☾</span> Moon in {moon_en}</span><span class="cp"><span class="g">△</span> {lagna_en} rising</span><span class="cp"><span class="g">♄</span> {compact} period</span></div>
  <div class="cov-comfort">The problem was never your effort. It was the timing — and timing changes.</div>
  <div class="cov-trust">Swiss Ephemeris · Lahiri ayanamsa · Generated {m.get("generated", "")}</div>
</div><div class="pno">01</div></section>

<!-- 02 NOTE FOR YOU -->
<section class="page note"><div class="col">
  <div class="noteframe">
    <div class="ne">A note for you</div>
    <div class="nh">Before you read on</div>
    <p>Dear {first}, the last few years asked a lot of you &mdash; and you kept going. In a testing phase, that persistence is exactly what compounds.</p>
    <p>{p.get("teaser", {}).get("breath", "")}</p>
    <div class="sig">&mdash; Your astrologer, AxtroShastra</div>
  </div>
</div><div class="pno">02</div></section>

<!-- 03 SUMMARY -->
<section class="page"><div class="col">
  <div class="eyebrow">In one look</div>
  <h2 class="head">Your business, in one look</h2>
  <div class="rule"></div>
  <div class="sgrid">
    {summary_cards}
  </div>
  <div class="sfoot">Every line above is explained in the pages that follow, with the reason from your chart. This is a phase with an end date — not a verdict on you.</div>
</div><div class="pno">03</div></section>

<!-- 04 HOW YOU WORK -->
<section class="page"><div class="col">
  <div class="eyebrow">Your business nature</div>
  <h2 class="head">How you work</h2>
  <div class="rule"></div>
  <div class="verdict gold sum"><svg class="ic"><use href="#i-scales"/></svg> How you naturally work — your strength is trust, and your growth is deciding a little faster.</div>
  <div class="lead">{lead_nature}</div>
  <div class="pts">
    <div class="pt"><svg class="ic pi"><use href="#i-scales"/></svg><div class="tx"><b>{lagna_en} rising — your business face</b>{nature.get("lagna_line", "")}.</div></div>
    <div class="pt warn"><svg class="ic pi"><use href="#i-alert"/></svg><div class="tx"><b>Your weak spot</b>{nature.get("weak_spot", "")}.</div></div>
    <div class="pt"><svg class="ic pi"><use href="#i-moon"/></svg><div class="tx"><b>{moon_en} Moon — how you run things</b>{nature.get("moon_line", "")}.</div></div>
  </div>
  <a class="xlink" href="#p16">See your chart →</a>
</div><div class="pno">04</div></section>

<!-- 05 INSTINCT & PRESSURE -->
<section class="page"><div class="col">
  <div class="eyebrow">Your business nature</div>
  <h2 class="head">Your instinct &amp; how you take pressure</h2>
  <div class="rule"></div>
  <div class="verdict sum"><svg class="ic"><use href="#i-shield"/></svg> How you handle hard times — you stay steady, and the heavy phase now will pass.</div>
  <div class="lead">Two things decide whether a business owner survives the hard years: patience, and how they carry pressure.</div>
  <div class="pts">
    <div class="pt"><svg class="ic pi"><use href="#i-shield"/></svg><div class="tx"><b>A patient builder</b>You do your best work building something solid over time, not chasing quick, flashy wins. Your strength shows up in the long run — just don't let caution tip over into never moving at all.</div></div>
    <div class="pt"><svg class="ic pi"><use href="#i-moon"/></svg><div class="tx"><b>How your mind reads money</b>{nature.get("moon_line", "")}. Knowing this pattern is half of managing it.</div></div>
    <div class="pt {"warn" if sade_active else ""}"><svg class="ic pi"><use href="#i-hourglass"/></svg><div class="tx"><b>The weight now is real</b>{("The heaviness you feel is Sade Sati — a hard Saturn phase pressing on your mind. Read it as the weather of this stretch, not a flaw in you. It has a fixed end date around " + sade_ends + ".") if sade_active else ("Saturn is not in its heaviest phase for you right now — the usual discipline on cash and commitments is enough.")}</div></div>
  </div>
...
<section class="page"><div class="col">
  <div class="eyebrow">What business suits you</div>
  <h2 class="head">The work that fits you</h2>
  <div class="rule"></div>
  <div class="verdict gold sum"><svg class="ic"><use href="#i-compass"/></svg> The work that suits you — {p.get("teaser", {}).get("fit_label", "your best-fit line").lower()}.</div>
...
<!-- 07 PARTNERSHIP -->
<section class="page"><div class="col">
  <div class="eyebrow">Solo or partner</div>
  <h2 class="head">Should you go alone?</h2>
  <div class="rule"></div>
  <div class="verdict"><svg class="ic"><use href="#i-check"/></svg> {part.get("verdict", "A partner suits you")}</div>
  <div class="lead">{lead_partnership}</div>
  <div class="pts">
    <div class="pt good"><svg class="ic pi"><use href="#i-people"/></svg><div class="tx"><b>The blessing</b>{part.get("blessing", "")}.</div></div>
    <div class="pt warn"><svg class="ic pi"><use href="#i-alert"/></svg><div class="tx"><b>But choose carefully</b>{part.get("caution", "")}.</div></div>
    <div class="pt"><svg class="ic pi"><use href="#i-check"/></svg><div class="tx"><b>Who to pick</b>{part.get("who", "")}. Always put the deal in writing, and keep money transparent from day one.</div></div>
  </div>
  <a class="xlink" href="#p18">See the houses →</a>
</div><div class="pno">07</div></section>

<!-- 08 LAST 3 YEARS 1 -->
<section class="page"><div class="col">
  <div class="eyebrow terra">The last three years</div>
  <h2 class="head">Why it felt so hard</h2>
  <div class="rule"></div>
  <div class="verdict terra sum"><svg class="ic"><use href="#i-hourglass"/></svg> Why the last three years were the way they were — the cycle, not your effort.</div>
  <div class="lead">{lead_last3}</div>
  <div class="pts">
    {last_pts}
  </div>
  <a class="xlink" href="#p20">See the timeline →</a>
</div><div class="pno">08</div></section>

<!-- 09 LAST 3 YEARS 2 -->
<section class="page"><div class="col">
  <div class="eyebrow terra">The last three years</div>
  <h2 class="head">The pattern — and what it means</h2>
  <div class="rule"></div>
  <div class="callout dk"><div class="ch"><svg class="ic"><use href="#i-clock"/></svg> The whole stretch, in one line</div><p>{p.get("last3", {}).get("lead", "")}</p></div>
  <div class="pts">
    <div class="pt good"><svg class="ic pi"><use href="#i-trend"/></svg><div class="tx"><b>It is lifting now</b>The current {cur_md["lord"]} period runs to {cur_md["to"]}{(", and Sade Sati fully lifts by " + sade_ends) if sade_active else ""}. Crucially, your strong window — {window_label} — opens as that pressure eases.</div></div>
    <div class="pt"><svg class="ic pi"><use href="#i-compass"/></svg><div class="tx"><b>Why this matters</b>The same chart that explained the hard years also holds the good ones. What you're feeling is the turning point of a cycle, not the shape of your whole business life.</div></div>
  </div>
  <a class="xlink" href="#p20">See the timeline →</a>
...
<!-- 10 STRONG WINDOW 1 -->
<section class="page"><div class="col">
  <div class="eyebrow">When the road opens</div>
  <h2 class="head">Your strongest window</h2>
  <div class="rule"></div>
  <div class="herocard"><div class="hd">{window_label} <span class="hg">STRONG</span></div>
    <p>{sw.get("body", "")}</p></div>
  <div class="pts">
    <div class="pt good"><svg class="ic pi"><use href="#i-check"/></svg><div class="tx"><b>What to do</b>{" ".join(sw.get("do", []))}</div></div>
    <div class="pt warn"><svg class="ic pi"><use href="#i-alert"/></svg><div class="tx"><b>What not to do</b>{" ".join(sw.get("dont", []))}</div></div>
  </div>
  <a class="xlink" href="#p22">How this was scored →</a>
</div><div class="pno">10</div></section>

<!-- 11 STRONG WINDOW 2 -->
<section class="page"><div class="col">
  <div class="eyebrow">When the road opens</div>
  <h2 class="head">The years after</h2>
  <div class="rule"></div>
  <div class="lead">{lead_windows}</div>
  {years_wins}
  <div class="note">Windows raise your odds — they don't remove the effort. Even a strong window still rewards the work you put in.</div>
  <a class="xlink" href="#p22">How this was scored →</a>
</div><div class="pno">11</div></section>

<!-- 12 RISK -->
<section class="page"><div class="col">
  <div class="eyebrow terra">Careful stretches</div>
  <h2 class="head">When to hold back</h2>
  <div class="rule"></div>
  <div class="verdict terra sum"><svg class="ic"><use href="#i-alert"/></svg> When to play it safe — keep cash in hand and avoid big risks in the careful stretches below.</div>
  <div class="lead">A caution window doesn't mean everything goes wrong — it means being careful here is the smart play. The owner who knows cash will be tight simply plans for it in advance.</div>
  <div class="pts">
    {careful_pts}
  </div>
  <a class="xlink" href="#p24">See why →</a>
</div><div class="pno">12</div></section>

<!-- 13 MONEY 1 -->
<section class="page"><div class="col">
  <div class="eyebrow">Money &amp; cash flow</div>
  <h2 class="head">How money moves for you</h2>
  <div class="rule"></div>
  <div class="verdict gold sum"><svg class="ic"><use href="#i-coins"/></svg> How money comes and goes — the earning, the growing, and where it leaks.</div>
  <div class="lead">{lead_money}</div>
  <div class="pts">
    <div class="pt"><svg class="ic pi"><use href="#i-coins"/></svg><div class="tx"><b>How you earn</b>{money.get("earn_leak", "")}.</div></div>
    <div class="pt"><svg class="ic pi"><use href="#i-trend"/></svg><div class="tx"><b>How gains arrive</b>{money.get("gains", "")}.</div></div>
    <div class="pt"><svg class="ic pi"><use href="#i-shield"/></svg><div class="tx"><b>Keep a reserve</b>{money.get("reserve", "")}</div></div>
  </div>
  <a class="xlink" href="#p26">See the wealth check →</a>
</div><div class="pno">13</div></section>

<!-- 14 MONEY 2 -->
<section class="page"><div class="col">
  <div class="eyebrow">Money &amp; cash flow</div>
  <h2 class="head">Your wealth potential</h2>
  <div class="rule"></div>
  <div class="callout"><div class="ch"><svg class="ic"><use href="#i-gem"/></svg> {"You have a wealth combination" if dy_present else "Wealth built by effort"}</div><p>{dy_line}</p></div>
  <div class="pts">
    <div class="pt"><svg class="ic pi"><use href="#i-coins"/></svg><div class="tx"><b>How your wealth actually grows</b>{money.get("earn_leak", "")}, so holding on is the real work — and {money.get("gains", "")}.</div></div>
    <div class="pt good"><svg class="ic pi"><use href="#i-trend"/></svg><div class="tx"><b>Best money years from your strong window</b>As the {window_lord} period settles in ({window_label}), your wealth pattern truly comes alive. Your strongest years for building money are still ahead of you.</div></div>
  </div>
</div><div class="pno">14</div></section>

<!-- 15 OBSTRUCTION -->
<section class="page"><div class="col">
  <div class="eyebrow terra">What's holding you</div>
  <h2 class="head">The blocks, honestly</h2>
  <div class="rule"></div>
  <div class="callout dk"><div class="ch"><svg class="ic"><use href="#i-hourglass"/></svg> {("Sade Sati (" + sade_phase + ") — until " + sade_ends) if sade_active else "The current testing phase"}</div><p>{("Saturn is sitting on your Moon, the heaviest weather of this cycle. It brings delays, low confidence, and money worry — but it is a test with a fixed end date, and those who ride it out with discipline come out stronger.") if sade_active else ("The current sub-period asks for patience more than expansion. It passes — and the roadmap ahead shows exactly when.")}</p></div>
  <div class="pts">
    <div class="pt warn"><svg class="ic pi"><use href="#i-moon"/></svg><div class="tx"><b>The shadow planets</b>Rahu sits in your {_vy_ordinal(rahu_h)} house and Ketu in your {_vy_ordinal(ketu_h)} — together they scatter focus and add restlessness and over-thinking. This lighter block eases as the {cur_md["lord"]} period closes ({cur_md["to"]}).</div></div>
    <div class="pt good"><svg class="ic pi"><use href="#i-check"/></svg><div class="tx"><b>None of it is permanent</b>Both blocks are passing cycles, not the shape of your chart. Naming them is the first step to managing them.</div></div>
  </div>
  <a class="xlink" href="#p24">See the detail →</a>
...
<section class="page"><div class="col">
  ...
  <div class="rule"></div>
  <div class="callout"><div class="ch"><svg class="ic"><use href="#i-check"/></svg> Simple, classical remedies</div><p>{rem_note}</p></div>
  <div class="pts">
    {rem_pts}
  </div>
...
<section class="page" id="p16"><div class="col">
  <div class="eyebrow">Your chart · the proof</div>
  ...
  <div class="klegend">Your birth chart, South-Indian style · Ascendant marked in gold. Every reading in this report is calculated from this chart — nothing is guessed, and any astrologer can verify it.</div>
...
<section class="page" id="p18"><div class="col">
  <div class="eyebrow">Your chart · business houses</div>
  <h2 class="head">The houses that matter</h2>
  <div class="rule"></div>
  <div class="lead">A handful of houses run a business. Here are the ones your chart puts front and centre.</div>
  <div class="pts">
    {houses_pts_1}
  </div>
...
<section class="page"><div class="col">
  <div class="eyebrow">Your chart · business houses</div>
  <h2 class="head">Gains, strength &amp; the loaded corner</h2>
  <div class="rule"></div>
  <div class="pts">
    {houses_pts_2}
  </div>
...
<section class="page" id="p20"><div class="col">
  <div class="eyebrow">Your chart · timeline</div>
  <h2 class="head">Your timeline — the recent stretch</h2>
  <div class="rule"></div>
  <div class="lead">Your life runs in planetary periods, called dashas. These are the recent sub-periods — and they explain the stretch behind you.</div>
  <div class="tl">
    {last_tl}
  </div>
...
<section class="page"><div class="col">
  <div class="eyebrow">Your chart · timeline</div>
  <h2 class="head">Your timeline — the years ahead</h2>
  <div class="rule"></div>
  <div class="lead">And these are the periods that take over next — the shape of the road in front of you.</div>
  <div class="tl">
    {road_tl}
  </div>
...
<section class="page" id="p22"><div class="col">
  <div class="eyebrow">Your chart · window scoring</div>
  <h2 class="head">Why "Strong" — shown</h2>
  <div class="rule"></div>
  <div class="lead">Nothing in this report is guessed. Your strongest window earns its grade from clear facts in your chart. Here is why {window_lord}'s window stands out.</div>
  <div class="pts">
    {strong_pts}
  </div>
...
<section class="page"><div class="col">
  <div class="eyebrow">Your chart · window scoring</div>
  <h2 class="head">The other windows</h2>
  <div class="rule"></div>
  <div class="pts">
    {other_pts}
  </div>
  <div class="note"><b>Windows are chances, not fixed dates.</b> They raise your odds; the effort is still yours to bring.</div>
</div><div class="pno">24</div></section>

<!-- 25 SADE SATI 1 -->
<section class="page" id="p24"><div class="col">
  <div class="eyebrow">Your chart · Sade Sati</div>
  <h2 class="head">Sade Sati, explained</h2>
  <div class="rule"></div>
  <div class="pts">
    <div class="pt"><svg class="ic pi"><use href="#i-saturn"/></svg><div class="tx"><b>What it is</b>{("Saturn is passing over your Moon — the " + sade_phase + " of the seven-and-a-half-year Sade Sati. It ends around " + sade_ends + ".") if sade_active else "Sade Sati is not running on your Moon right now — Saturn's heaviest cycle is not the story of this phase for you."}</div></div>
    <div class="pt warn"><svg class="ic pi"><use href="#i-alert"/></svg><div class="tx"><b>What you feel</b>Delays, heavier decisions, and a steadier worry about money. It's real, and — importantly — it's temporary.</div></div>
    <div class="pt good"><svg class="ic pi"><use href="#i-check"/></svg><div class="tx"><b>The good news</b>{("Its end (" + sade_ends + ") falls near your strong " + window_label + " window — so the weight lifts close to when your best years get going.") if sade_active else ("Your strongest window — " + window_label + " — is the part of the road to plan around.")}</div></div>
  </div>
</div><div class="pno">25</div></section>

<!-- 26 SADE SATI 2 -->
<section class="page"><div class="col">
  <div class="eyebrow">Your chart · the shadow planets</div>
  <h2 class="head">Rahu, Ketu &amp; the shadows</h2>
  <div class="rule"></div>
  <div class="pts">
    <div class="pt warn"><svg class="ic pi"><use href="#i-moon"/></svg><div class="tx"><b>Rahu in your {_vy_ordinal(rahu_h)} house</b>Adds worry, restlessness and over-thinking to the current stretch — the day-to-day strain you've been feeling.</div></div>
    <div class="pt"><svg class="ic pi"><use href="#i-coins"/></svg><div class="tx"><b>Ketu in your {_vy_ordinal(ketu_h)} house</b>Pulls you toward letting-go — part of why focus and, at times, money slip away so easily right now.</div></div>
    <div class="pt good"><svg class="ic pi"><use href="#i-check"/></svg><div class="tx"><b>They fade with the {cur_md["lord"]} period</b>As it closes ({cur_md["to"]}), these shadow influences loosen their grip. They are passing transits, not permanent features of your chart.</div></div>
  </div>
</div><div class="pno">26</div></section>

<!-- 27 DHANA -->
<section class="page" id="p26"><div class="col">
  <div class="eyebrow">Your chart · wealth</div>
  <h2 class="head">Wealth combinations</h2>
  <div class="rule"></div>
  <div class="lead">We checked your chart for the classical wealth combinations (Dhana Yogas). Here is what we found.</div>
  <div class="pts">
    <div class="pt {"good" if dy_present else ""}"><svg class="ic pi"><use href="#i-gem"/></svg><div class="tx"><b>{"You have a wealth yoga" if dy_present else "Wealth by deliberate effort"}</b>{dy_line}</div></div>
    <div class="pt"><svg class="ic pi"><use href="#i-trend"/></svg><div class="tx"><b>Where gains come from</b>{money.get("gains", "")}.</div></div>
    <div class="pt"><svg class="ic pi"><use href="#i-shield"/></svg><div class="tx"><b>Hold the line on cash</b>{money.get("reserve", "")}</div></div>
  </div>
</div><div class="pno">27</div></section>

<!-- 28 YEAR BY YEAR -->
<section class="page"><div class="col">
  <div class="eyebrow">Your chart · year by year</div>
  <h2 class="head">The next years</h2>
  <div class="rule"></div>
  <div class="lead">A quick year-by-year view, so you can hold the shape of what's coming.</div>
  <div class="tl">
    {yby_tl}
  </div>
  <div class="note" style="text-align:center;border:0">Guidance, not a guarantee. Timing windows are chances, not fixed dates. This is not legal or financial advice.</div>
</div><div class="pno">28</div></section>

<!-- 29 ENDING -->
<section class="page end"><div class="col">
  <div class="eyebrow">With gratitude</div>
  <h2 class="head">Thank you, {first}</h2>
  <div class="rule"></div>
  <div class="lead" style="text-align:center;max-width:34ch">Thank you for trusting AxtroShastra with your business questions. We hope this reading brings you clarity — and a little calm — about the road ahead.</div>
  <div class="intro" style="text-align:center;margin-top:14px">Have another question about your life? Each of these is on our site, computed the same honest way:</div>
  <div class="svc">
    <div class="s"><svg class="ic si"><use href="#i-people"/></svg><div class="st"><b>Compatibility</b>Whether two charts truly work together.</div></div>
    <div class="s"><svg class="ic si"><use href="#i-check"/></svg><div class="st"><b>Marriage Timing</b>When marriage is most likely, and with whom.</div></div>
    <div class="s"><svg class="ic si"><use href="#i-compass"/></svg><div class="st"><b>Job Change</b>The right time to switch jobs — and where to go next.</div></div>
    <div class="s"><svg class="ic si"><use href="#i-trend"/></svg><div class="st"><b>Vyapar — Business</b>This report: when to build, when to hold.</div></div>
  </div>
  <div class="endbrand">Every AxtroShastra report is computed from your real birth chart &mdash; never guessed. That is our promise.</div>
