...
CAREER_HOUSE_HI = [
    ...
    "सेवा और समस्या सुलझाने वाला काम — कानून, ऑपरेशंस, मुक़ाबले वाले क्षेत्र",
...
HEALTH_6_HI = [
    "तेज़ रफ़्तार वाली दिनचर्या — गुस्से और जल्दबाज़ी पर काबू रखें, दिन आसान चलेगा",
    "आराम जो कब सुस्ती बन जाए पता नहीं चलता — नियमित दिनचर्या और संयम आपको बचाते हैं",
    "व्यस्त, बेचैन मन — उसे जान-बूझकर आराम दें, एक समय में एक ही काम",
    "दिनचर्या जो मूड का आईना है — मूड सँभला तो दिन भी सँभला",
    "बड़े जोश वाली ऊर्जा — अचानक ज़ोर लगाने से बेहतर है टिकाऊ रफ़्तार",
    "बारीकी और चिंता साथ चलती हैं — बारीकी काम में मदद करती है, पर नींद बिगाड़ती है; दोनों को अलग रखें",
    "संतुलन ही रोज़ की मूल बात — स्थिर दिनचर्या और हर चीज़ में संतुलन ज़रूरी है",
    "सब-कुछ-या-कुछ-नहीं वाले गहरे पैटर्न — अंदाज़ों के बजाय नियमित छोटे-छोटे ठहराव",
    "हर चीज़ ज़्यादा पाने की चाहत — ज़्यादा पाने की चाहत पर लगाम ज़रूरी है",
    "लंबी दौड़ का दमखम और पुरानी आदतें — तेज़ी से ज़्यादा असरदार है निरंतरता",
    "एक जगह रुके रहने से जमा होता तनाव — चलना-फिरना ही आपका असली रीसेट है",
    "हर किसी की थकान ओढ़ लेने की आदत और नींद — सीमाएँ तय करना आपकी ऊर्जा की भी रक्षा करता है",
]
HOME_4_HI = [
...
AREA_LABEL_HI = {
    ...
    "health": "ऊर्जा और दिनचर्या", "growth": "व्यक्तिगत विकास और पहचान", "family": "पारिवारिक रिश्ते",
    "timing": "समय",
}
...
HOUSE_AREA_LINE_HI = {
    ...
    6: "ऊर्जा और दिनचर्या के रूप में शामिल",
...
AREA_TITLE_HI = {
    ...
    "health": "आपकी ऊर्जा आम तौर पर कैसे चलती है", "growth": "क्या सहज आता है, और क्या नहीं",
...
AREA_REFLECT_HI = {
    ...
    "health": "आपकी दिनचर्या आपको पहले से क्या बता रही है, जिसे आप अनसुना करते आ रहे हैं?",
...
AREA_DO_HI = {
    ...
    "health": ["नियमित नींद और खाने के समय को किसी भी नई दिनचर्या से ज़्यादा प्राथमिकता दें।",
               "थकान के शुरुआती संकेतों को गंभीरता से लें, इंतज़ार करने के बजाय।",
...
AREA_WATCH_HI = {
    ...
    "health": ["सिर्फ़ इसलिए अच्छी आदतें न छोड़ें क्योंकि अभी सब ठीक चल रहा है।"],
...
_WHEEL_LABEL_HI = {"career": "करियर", "money": "पैसा", "marriage": "विवाह",
                    ...
                    "health": "ऊर्जा", "growth": "विकास", "family": "परिवार",
                    "timing": "समय"}
...
def render_blueprint_hi(p: dict) -> str:
  ...
  <div class="sccols">
    <div class="sccard str"><div class="sch">{icon('i-check')} हम ईमानदारी से आपको क्या बता सकते हैं</div>
      ...
      <div class="scitem">पारंपरिक ऊर्जा और दिनचर्या प्रवृत्तियाँ, एक सामान्य पैटर्न के रूप में।</div>
    </div>
